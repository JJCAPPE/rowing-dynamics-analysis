...
from rowing.pose.progress_utils import clamp01
from rowing.pose.kinematics.kinematics import compute_basic_angles_h36m17
from rowing.pose.kinematics.model_assets import (
    DEFAULT_MOTIONBERT_MODEL,
    MOTIONBERT_REPO,
    ensure_asset,
    get_motionbert_model,
)
from rowing.pose.kinematics.motionbert_format import prepare_motionbert_input_from_coco
from rowing.pose.kinematics.motionbert_lift import lift_pose3d_motionbert
from rowing.pose.kinematics.skeletons import H36M17_JOINT_NAMES
